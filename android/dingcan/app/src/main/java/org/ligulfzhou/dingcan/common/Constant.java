package org.ligulfzhou.dingcan.common;
...
public class Constant {
    ...
    public static final String ACCOUNT_MOBILE = "userlogin.email";
    public static final String ACCOUNT_USERNAME = "userlogin.username";
